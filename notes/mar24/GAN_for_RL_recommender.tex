...
\begin{document}
    ...
    The "user" in this scenario is the environment which we interact with by selecting videos/documents to recommend.

    \textbf{State}

    The current environment state refers to "an ordered sequenceof a user’s historical clicks"
