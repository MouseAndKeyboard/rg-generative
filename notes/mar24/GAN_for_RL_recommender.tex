...
\begin{document}
    ...
    *This problem is addressed through their \emph{Cascading Q-Network} architecture.
    ...
    Importantly, measuring a users utility is a hard task* as we do not know $\phi ^*$ and often times "synthetic" reward signals are crafted (e.g. +1 reward whenever you click an item).

    *This problem is addressed through their \emph{Generative Adversarial User Model}
