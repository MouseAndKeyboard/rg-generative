...
\begin{document}
    ...
    \begin{enumerate}
        \item Users are not passive. Given a set of $k$ items, users will attempt to maximise their own reward $r$.
        ...
        \item Reward is the marginal benefit of taking an action, this means that $r$ depends not only on the video about to be watched but also the user's watch history leading up to this video.
    \end{enumerate}
