...
\begin{enumerate}
    \item What was the probability of selecting this action AT THE TIME OF SELECTION (under the \textbf{old policy})
    \item What is the probability of selecting this action UNDER THE \textbf{NEW POLICY}
    \item The \textbf{advantage estimate} of that action taken (this is computed right after taking this action by, typically, a neural network)
\end{enumerate}
